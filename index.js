...
app.get("/", (req, res) => {
    ...
    res.send(`<svg viewBox="0 0 240 80" xmlns="http://www.w3.org/2000/svg"> <style>.small{font:italic 13px sans-serif;fill:#fff}</style> <text x="20" y="35" class="small">Hello! You are visitor ${visitor}</text></svg>`)
})
